...
import com.epam.drill.agent.test.jvmti.classFileLoadHook
import com.epam.drill.agent.test.jvmti.vmInitEvent
import com.epam.drill.agent.test.jvmti.vmDeathEvent
...
import com.epam.drill.agent.test.configuration.AgentLoggingConfiguration
import com.epam.drill.agent.test.configuration.Configuration
import com.epam.drill.agent.test.configuration.ParameterDefinitions.FRAMEWORK_PLUGINS
...
object Agent {
    ...
    private val logger = KotlinLogging.logger("com.epam.drill.agent.test.Agent")
