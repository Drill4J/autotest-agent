...
@Suppress("UNUSED")
@CName("Java_com_epam_drill_test_agent_ThreadStorage_startSession")
...
@Suppress("UNUSED")
@CName("Java_com_epam_drill_test_agent_ThreadStorage_stopSession")
fun stopSession(env: JNIEnv, thiz: jobject) = callNativeVoidMethod(env, thiz, ThreadStorage::stopSession)

@Suppress("UNUSED", "UNUSED_PARAMETER")
@CName("Java_com_epam_drill_test_agent_ThreadStorage_sendSessionData")
fun sendSessionData(
    env: JNIEnv,
    thiz: jobject,
