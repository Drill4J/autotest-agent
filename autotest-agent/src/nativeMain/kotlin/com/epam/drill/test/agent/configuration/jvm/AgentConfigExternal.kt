...
@Suppress("UNUSED")
@CName("Java_com_epam_drill_test_agent_configuration_AgentConfig_apiKey")
fun apiKey(env: JNIEnv, thiz: jobject) = callNativeStringMethod(env, thiz, AgentConfig::apiKey)
