...
import com.epam.drill.agent.test.instrument.clients.ApacheHttpClientTransformer
import com.epam.drill.agent.test.instrument.clients.JavaHttpClientTransformer
import com.epam.drill.agent.test.instrument.clients.OkHttp3ClientTransformer
import com.epam.drill.agent.test.instrument.clients.SpringWebClientTransformer
import com.epam.drill.agent.test.instrument.clients.*
import com.epam.drill.agent.test.instrument.servers.ReactorTransformer
import com.epam.drill.agent.test.instrument.strategy.selenium.*
import com.epam.drill.agent.test.instrument.strategy.kafka.*
